...
<main id="mainArticle">
        <article>
                <section class="title-group">
                    <h1 data-aos="fade-down" data-aos-duration="1000" data-aos-easing="ease-out">WHAT IS CRYPTO MINING ?</h1>
                    <h2 data-aos="slide-right" data-aos-duration="1000" data-aos-easing="ease-out">How is this all happening? What role is the miner playing? And how might this change the landscape of computing in the future?</h2>
                    <div id="auteur">
                        <em>
            ...
            <div class="wrapper" id="article">
                <picture class="intro-pic">
                    <img src="../img/2021-04-29-image-5.png" alt="image crypto mining" id="imgMinecraft">
                </picture>
                <div class="articleBody">
                    <p class="noMargin">On January 3, 2009, the first Bitcoin mining operation went underway, and a 50 BTC reward was sent to address <em>1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa</em>. Although unconfirmed, it most likely went to the mysterious Satoshi Nakamoto, the inventor of Bitcoin. While no official transactions were recorded in the genesis block, the embedded text, “The Times 03/Jan/2009 Chancellor on brink of second bailout for banks” was a nod to the financial crisis of the time, and a major motivator behind the decentralized currency’s inception.</p>
                    <p class="noMargin">Fast forward to May 2021, and those 50 bitcoins would collect you a cool $2.9 million USD. However, due to either a quirk in the system or an intentional implementation in the code, the first 50 BTC can’t be spent. Instead, the first mining operation launched what would become global recognition of Satoshi Nakamoto’s vision of a decentralized currency, and become a financial and technical force to be reckoned with.</p>
                    <p class="noMargin">Today, there are at least 1 million unique “miners” for Bitcoin alone, not to mention all the other crypto currencies in existence. These miners are typically in the news for the wrong reasons: expending terawatt-hours of energy annually (.51% of the global electricity production) for mining purposes; gulping up GPUs on launch day despite the silicon shortage; and introducing novel, yet somewhat controversial, digital use cases such as CryptoKitties and non-fungible tokens (NFTs).</p>
                    <p class="noMargin">How is this all happening? What role is the miner playing? And how might this change the landscape of computing in the future?</p>
                    <p class="noMargin">Before diving into the details of crypto currency mining, it is worth understanding Satoshi’s original vision regarding the motivation of a cryptocurrency, and the use of the blockchain to address a set of very specific technical problems.</p>
                    <h2 id="Satoshis_Vision" data-aos="slide-right" data-aos-duration="1000" data-aos-easing="ease-out">Satoshi’s Vision</h2>
                    <p class="noMargin">According to the original whitepaper, Bitcoin is “a purely peer-to-peer version of electronic cash” aimed directly at modern financial institutions which act as middlemen for financial transactions. The primary issue regarding modern financial institutions, according to Satoshi Nakamoto, is the inherent trust required for all transactions.</p>
                    <p class="noMargin">This trust could potentially lead to <a href="">unidentifiable fraud</a> by the middleman, incur a high cost of mediation between <a href="">customers</a>, or involve complexity even with small, casual transactions as common as a <a href="">wire transfer</a>.</p>
                    <p class="noMargin">To address these issues, Satoshi described a distributed (i.e., not centralized) electronic payment system based on cryptographic proof instead of trust. Such a scheme, he argued, would make financial transactions immutable and “computationally impractical to reverse” and help protect against fraud. All this while also getting rid of the need for a trusted third party during transactions.</p>
                    <p class="noMargin">While great in theory, there was one minor technical challenge that needed ironing out. Namely, in a public ledger, anyone could claim a transaction even without the necessary funds. Who is there to arbitrate and assert that all transactions being performed are backed up by the appropriate amount of funds?</p>
                    <p class="noMargin">To make a decision, you should consider many of the following and perhaps <a href="">use a calculator</a>:</p>
                    <ul id="ulArticle">
