...
<main id="mainArticle">
    <article>
        <section class="title-group">
            <h1 data-aos="fade-down" data-aos-duration="1000" data-aos-easing="ease-out">MINECRAFT LIVE IS BACK ONE AGAIN</h1>
            <h2 data-aos="slide-right" data-aos-duration="1000" data-aos-easing="ease-out">LOREM IPSUM DOLOR SIT AMET</h2>
            <div id="auteur">
                <em>
        ...
        <div class="wrapper" id="article">
            ...
            <div class="articleBody">
                ...
                <p class="noMargin">A alias amet animi beatae, deserunt earum eligendi eveniet expedita ipsa ipsam itaque molestiae nihil
                    nobis odit, omnis optio quam quasi quia repellat reprehenderit sit tempora tenetur totam vero
                    voluptatum?</p>
                <p class="noMargin">Accusamus aut autem blanditiis delectus dicta doloribus dolorum esse et harum hic id labore minus,
                    mollitia, nemo obcaecati odit placeat provident quam quod repellat saepe sint tempore temporibus
                    veritatis vero!</p>
                <p class="noMargin">At atque dignissimos dolore eaque fugiat id quasi sint unde. Accusamus debitis deleniti enim est
                    facere minus, nulla obcaecati odit optio porro praesentium quasi quibusdam tempore tenetur unde ut
                    voluptatibus?</p>
                <p class="noMargin">Aperiam iste modi numquam quam tempore, voluptatibus? Aperiam autem blanditiis dolorem enim error
