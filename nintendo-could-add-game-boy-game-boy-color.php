        ...
        <article>
            <section class="title-group">
                ...
                <div id="auteur">
                    <em>
                        ...
                        <time content="2021-09-03T11:51:00-05:00" datetime="2021-09-03T11:51:00-05:00" pubdate="pubdate">
            ...
            <div class="wrapper" id="article">
                <picture class="intro-pic">
                    <img src="../img/nintendo.jpg" alt="Nintendo could add Game Boy, Game Boy Color titles to Switch Online service 'really soon'" id="imgMinecraft">
                </picture>
                <div class="articleBody">
                    <p class="noMargin"><strong>Why it matters:</strong> Nintendo is preparing to add Game Boy and Game Boy Color games to its Switch Online subscription service, multiple independent sources are reporting. With the three year anniversary of the service just a couple of weeks out, now would be a great time for Nintendo to boost the value of its offering even further. </p>
                    <p class="noMargin">The <a href="#">Nate the Hate podcast</a> was first to report on the development earlier this week. <a href="#">Nintendo Life</a> then chimed in, claiming its sources had confirmed to them that Game Boy and Game Boy Color titles were coming to the service “really soon.” Now, <a href="#">Eurogamer</a> has come forward to say that its own sources have also corroborated the reports.</p>
                    <p class="noMargin">Nintendo <a href="#">launched</a> its Switch Online service on September 18, 2018. In addition to enabling online play, the service granted access to a persistent and expanding library of Nintendo Entertainment System games. A year later, Nintendo added <a href="#">SNES games</a> to the mix.</p>
                    <p class="noMargin">Also of note is the fact that data miners in 2019 discovered four emulation types in the NES Switch app: the NES and SNES, and two unaccounted for emulators named Hiyoko and Count. It is believed that Hiyoko could be an emulator for the Game Boy and Game Boy Color.</p>
                    <p class="noMargin">So, what about that fourth emulator type? The jury is still out on this one, but with a <a href="#">Nintendo 64 Classic Edition</a> seemingly no longer in the cards, some are no doubt hopeful that the <a href="#">last great cartridge-based console</a> could fill this slot.</p>
                    <p class="noMargin" id="share">Share this article:</p>
                    <a href="https://facebook.com" class="reseauSocial"><svg version="1.1" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve"><path d="M18.768,7.465H14.5V5.56c0-0.896,0.594-1.105,1.012-1.105s2.988,0,2.988,0V0.513L14.171,0.5C10.244,0.5,9.5,3.438,9.5,5.32 v2.145h-3v4h3c0,5.212,0,12,0,12h5c0,0,0-6.85,0-12h3.851L18.768,7.465z"></path></svg>
                    </a>
